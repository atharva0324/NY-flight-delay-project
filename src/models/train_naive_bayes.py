...
def main():
    ...
    plt.tight_layout()
    plt.savefig("outputs/models/nb_confusion_matrix.png", dpi=200)
    plt.close()
    ...
    }]).to_csv("outputs/models/nb_metrics.csv", index=False)

    with open("models/nb_model.pkl", "wb") as f:
        pickle.dump(model, f)

    print("\nSaved:")
    print("- outputs/models/nb_confusion_matrix.png")
    print("- outputs/models/nb_metrics.csv")
